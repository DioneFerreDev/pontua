...
function login() {
    ...
    entrar.addEventListener("click", async e => {
        ...
        try {            
            ...
            //     // tentar aqui fazer toda a parte de salvamento em bcrypt do user e pegar o user cry

            //     const dados = { nome: admin.user, level: admin.isAdmin }
            //     const options_Adm = {
            //         method: "POST",
            //         credentials: 'include',
            //         headers: {
            ...
            //     const URL_TOKEN_CLIENTE = "/adm/AuthEmpresa/setarToken";
            //     const res2 = await new GenerateFetch(URL_TOKEN_CLIENTE, options_Adm);
            //     console.log('resposta aqui do token do adm')
